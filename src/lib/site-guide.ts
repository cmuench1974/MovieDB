  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        "Search from the header for titles, actors, or directors. Suggestions appear after two characters; click one to apply that filter.",
        "Filter by genre and year; each list only offers values that still match the other filters. Click a genre or year to apply it immediately.",
        "Poster cards show the year and director when known.",
        "Open a title for plot, director, cast, runtime, and technical details (resolution, codecs, audio, subtitles).",
        "On a title page, tap a genre to open the catalog filtered to it. Names in Directed by and Cast open that person’s other titles in your catalog.",
        "Some titles have more than one file (for example HD and UHD). Switch versions on the detail page.",
        "Back returns to the previous catalog, search, list, or person page and highlights the title you just viewed.",
      ],
    },
    {
      title: "Lists",
      items: [
        ...
        "On a movie page, pick a list or New list. New list asks for a name; that title is added automatically. List owners can later remove titles or change who can see the list.",
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        "Update file info re-reads filename, size, video (codec, HDR), audio, and subtitles for files already in the library. Titles and artwork stay as they are.",
        "Update metadata refreshes TMDB title, overview, cast, directors, and genres. Chosen posters and backdrops stay as they are. Existing titles need this once so actor and director pages fill in.",
